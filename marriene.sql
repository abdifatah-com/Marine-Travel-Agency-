...
CREATE TABLE Users (
    ...
    Role NVARCHAR(20) DEFAULT 'Agent', ProfileImageUrl NVARCHAR(MAX) DEFAULT '~/assets/img/default-avatar.png', -- Admin, Agent
...
BEGIN
    ...
    BEGIN
        INSERT INTO Bookings (TripId, CustomerName, CustomerEmail, CustomerPhone, NumberOfGuests, TotalAmount)
        VALUES (@TripId, @CustomerName, @CustomerEmail, @CustomerPhone, @NumberOfGuests, @Price * @NumberOfGuests);
